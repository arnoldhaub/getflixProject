            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='../MoviesPreview/movie_preview.php?id=" . $latestMovie->results[0]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='../MoviesPreview/movie_preview.php?id=" . $latestMovie->results[1]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                        <button type="button" class="btn play"><i class="fa-solid fa-play" id="fa-play"></i>PLAY !</button>
                        </a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='../MoviesPreview/movie_preview.php?id=" . $latestMovie->results[2]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                        <button type="button" class="btn play"><i class="fa-solid fa-play" id="fa-play"></i>PLAY !</button>
                        </a>
                    </div>
                </div>
                ...
                foreach ($moviesLatest->results as $p) { // RECENT SF MOVIE
                    if (!empty($p->poster_path && $p->backdrop_path)) {
                        echo  "<div class='swiper-slide'>
                            <a href='../MoviesPreview/movie_preview.php?id=" . $p->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'><img src='" . $imgurl_500 . $p->poster_path . "' id='videoTrailer'></a>
                        </div>";
                    }
                } ?>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                foreach ($moviesPopular->results as $p) { // POPULAR SF MOVIE
                    if (!empty($p->poster_path && $p->backdrop_path)) {
                        echo  "<div class='swiper-slide'>
                            <a href='../MoviesPreview/movie_preview.php?id=" . $p->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'><img src='" . $imgurl_500 . $p->poster_path . "'></a>
                        </div>";
                    }
                } ?>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                foreach ($seriesLatest->results as $p) { // SF & FANTAST - SERIES
                    if (!empty($p->poster_path && $p->backdrop_path)) {
                        echo  "<div class='swiper-slide'>
                            <a href='../MoviesPreview/serie.php?id=" . $p->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'><img src='" . $imgurl_500 . $p->poster_path . "'></a>
                        </div>";
                    }
                } ?>
