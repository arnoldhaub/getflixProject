            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='movie.php?id=" . $movieForKids->results[0]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='movie.php?id=" . $movieForKids->results[1]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                        <button type="button" class="btn play"><i class="fa-solid fa-play" id="fa-play"></i>PLAY !</button>
                        </a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <?php echo "<a href='movie.php?id=" . $movieForKids->results[2]->id . '&id_pseudo=' . $_SESSION['pseudo'] . "'>"; ?>
                        <button type="button" class="btn play"><i class="fa-solid fa-play" id="fa-play"></i>PLAY !</button>
                        </a>
                    </div>
                </div>
