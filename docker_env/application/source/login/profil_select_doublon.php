...
<body>
    <div class="container1">
                     ...
                     <div class="profile_select">
                        ...
                        <div class="profil_un">
                                    <div class="image_profile" style="text-align: center;">
                                             <img class="profil1" src="../images/user_pic/4.png" alt="default image" style="cursor: pointer">
                                             <svg class="test" version="1.1" id="Calque_3"  x="0px" y="0px"
                        ...
                        <div class="profil_deux">
                                    <div class="image_profile">
                                            <img class="profil2" src="../images/user_pic/4.png" alt="default image" style="cursor: pointer">
                                            <svg class="test" version="1.1" id="Calque_3"  x="0px" y="0px"
                                                        	 width="582.8px" height="582.8px" viewBox="0 0 582.8 582.8" style="enable-background:new 0 0 582.8 582.8;" 
                                                        	>
                                                        <style type="text/css">
                        ...
                        <div class="profil_trois">
                                     <div class="image_profile">
                                         <img class="profil3" src="../images/user_pic/4.png" alt="default image" style="cursor: pointer">
                                         <svg class="test" version="1.1" id="Calque_3"  x="0px" y="0px"
                                                        	 width="582.8px" height="582.8px" viewBox="0 0 582.8 582.8" style="enable-background:new 0 0 582.8 582.8;" 
                                                        	>
                                                        <style type="text/css">
                        ...
                        <div class="profil_quatre">
                                     <div class="image_profile">
                                              <img class="profil4" src="../images/user_pic/4.png" alt="default image" style="cursor: pointer">
                                              <svg class="test" version="1.1" id="Calque_3"  x="0px" y="0px"
                                                        	 width="582.8px" height="582.8px" viewBox="0 0 582.8 582.8" style="enable-background:new 0 0 582.8 582.8;" 
                                                        	>
                                                        <style type="text/css">
                ...
                <!--        <svg version="1.1" id="Calque_2" x="0px" y="0px"
