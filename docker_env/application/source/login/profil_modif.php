...
<body>
    <div class="container1">
        ...
        <div class="guillaume_box">
            ...
            $req = mysqli_query($db, "SELECT * FROM profile WHERE :id = $id");
            ...
            if (isset($_POST['Update'])) {
                ...
                if (isset($Pseudo) && isset($Categorie)) {
                    //requête de modification
                    $req = mysqli_query($con, "UPDATE profile SET pseudo = '$Pseudo' , categorie = '$Categorie' WHERE id = $id");
                    ...
                    //si non
                    $message = "Please complete all infos !";
                }
            }
            ...
            <div class="buttons1">
                <form method="post">
                    ...
                    <div class="img_creat_username_box">
                        <img class="w-25 mb-4 profile-pic-image" src="../images/default_user.jpg" alt="profil" style="cursor: pointer">
                    </div>
                    <!-- /////// NORDINE - END CODE AJOUTER ICI //////// -->
                    <div class="who_are_you_form">
                        <input type="text" class="Register0_loginForm" name="pseudo" label="Register" id="Register0_loginForm" value="<?= $row['pseudo'] ?>" /></button><br>
                        <select class="form-select mb-2" name="categorie" aria-label="Default select example" value="<?= $row['categorie'] ?>">
                            <option selected value="adulte">Adulte</option>
                            <option value="enfant">Enfant</option>
                        </select>
                        <button type="submit" class="Update_loginEnter" name="Update" label="Update" id="Update_loginEnter">UPDATE</button>
                            ...
                            <div class="row">
                                ...
                                <label for="4" class="lbl-radio">
                                    <div class="display-box">
                                        <img src="../images/user_pic/4.png" alt="" srcset="">
                                    </div>
