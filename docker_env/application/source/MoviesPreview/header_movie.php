<header>
    ...
    <nav style="align-self: center">
        <ul class="nav_links">
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>">HOME</a></li>
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>#ancre_serie">SERIES</a></li>
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>#ancre_film">FILMS</a></li>
            <li><a href="../Home/search.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>">RECHERCHE</a></li>
        </ul>

        <ul class="nav_links_responsive">
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>"><i class="fa-solid fa-house"></i></a></li>
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>#ancre_film"><i class="fa-solid fa-film"></i></i></a></li>
            <li><a href="../Home/home.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>#ancre_serie"><i class="fa-solid fa-tv"></i></i></a></li>
            <li><a href="../Home/search.php?id_pseudo=<?php echo $_SESSION['pseudo'] ?>"></a><i class="fa-solid fa-magnifying-glass"></i></i></a></li>
        </ul>
    </nav>
                ...
                <li class="mb-3 " style="list-style-type:none">
                    <div class="container">
                        <div style="flex-wrap:nowrap" class="row">
                            ...
                            <a style="color:white" href="../Home/home.php?id_pseudo=<?php echo $donnees[1] ?>"><?php echo $donnees[0] ?>
                            </a>
                        </div>
                    </div>
                </li>
